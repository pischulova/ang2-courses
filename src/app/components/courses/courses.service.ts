...
export class CoursesService {
	...
	public removeCourse(id: number) {
		console.log('service ', this.coursesList.length);
		this.coursesList = this.coursesList.filter((item) => item.id !== id);
		console.log('service, after delete ', this.coursesList.length);
	}
	...
	private coursesList: Item[] = [
	    {
	    	...
	    	description: `Babel has support for the latest version of JavaScript through syntax transformers. ` +
